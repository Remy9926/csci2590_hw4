...
def train_epoch(args, model, train_loader, optimizer, scheduler):
    ...
    for encoder_input, encoder_mask, decoder_input, decoder_targets, _ in tqdm(train_loader, desc="Training model..."):
        optimizer.zero_grad()
...
def eval_epoch(args, model, dev_loader, gt_sql_pth, model_sql_path, gt_record_path, model_record_path):
    ...
    return total_dev_loss / total_tokens, record_em, record_f1, sql_em, error_count / len(dev_loader.dataset)
